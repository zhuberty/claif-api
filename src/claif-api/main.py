from routers import users, auth, terminal_recordings, annotation_reviews, audio_recordings
...
app.include_router(audio_recordings.router, prefix="/v1/recordings/audio", tags=["audio"])
