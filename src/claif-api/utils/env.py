...
KEYCLOAK_CLIENT_ID = os.environ.get("KEYCLOAK_CLIENT_ID", "claif-api")
...
CLAIF_TRANSCRIBER_ENDPOINT = os.environ.get("CLAIF_TRANSCRIBER_ENDPOINT", "http://localhost:8002")
...
CLAIF_DB_HOST = os.environ.get("DB_HOST", "localhost")
CLAIF_DB_PORT = os.environ.get("DB_PORT", "5433")
